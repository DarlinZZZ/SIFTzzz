...
def get_rect(res, kp, goodnum, index):
    ...
    for i in res[:goodnum]:
        if index == 0:
            ...
            print(center)
            center_ori.append(center)
        elif index == 1:
            center = cv2.KeyPoint_convert(kp, keypointIndexes=[i.trainIdx])
            print(center)
            center_noise.append(center)

        center = [int(np.ravel(center)[0]), int(np.ravel(center)[1])]

        point_img.append(center)
    print('oriorioriorioriorioriorioriorioriorioriorioriorioriorioriori')
    print(center_ori)
    print('noisenoisenoisenoisenoisenoisenoisenoisenoisenoisenoisenoise')
    print(center_noise)



    # print('centercentercentercentercentercentercentercentercentercenter')
    # print(center)
    # print('centercentercentercentercentercentercentercentercentercenter')
...
if __name__ == '__main__':
    ...
    BFmatch(ori_path, cut_path, 155)
    # BFmatch(ori_path, cut_path, 220)
